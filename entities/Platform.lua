...
function getRandomDecoration()
  ...
  if decorationTypeIdx >= 0 and decorationTypeIdx <= 3 then decorationType = 'wine-glass'
  elseif decorationTypeIdx == 4 then decorationType = 'food-bell'
  elseif decorationTypeIdx >= 5 and decorationTypeIdx <= 6 then decorationType = 'bread'
  elseif decorationTypeIdx == 7 then decorationType = 'rose-in-vase' end
